...
export class default1670197272540 implements MigrationInterface {
    name = 'default1670197272540'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tickets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "seat" integer NOT NULL, "value" money NOT NULL, "date_session" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "session_id" uuid, CONSTRAINT "REL_73f270d03cacce3e2eac969834" UNIQUE ("session_id"), CONSTRAINT "PK_343bc942ae261cf7a1377f48fd0" PRIMARY KEY ("id"))`);
