...
export class default1670185041838 implements MigrationInterface {
    name = 'default1670185041838'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "tickets" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "seat" integer NOT NULL, "value" money NOT NULL, "date_section" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "section_id" uuid, CONSTRAINT "REL_3eb8d5dac79061eea1650feb2b" UNIQUE ("section_id"), CONSTRAINT "PK_343bc942ae261cf7a1377f48fd0" PRIMARY KEY ("id"))`);
